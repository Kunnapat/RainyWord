...
public class LinkedList {
	...
	/*
	 * return iterator that points to the node next to header (can be null if
	 * the list is empty.)
	 */
	 ...
	 * 
	 * @param x
	 *            item to be in the new node.
	 * @param p
	 *            iterator of the position before the new node.
	 */
	...
	/**
	 * @param x
	 *            object that we want to find.
	 * @return iterator that points to the first node that has x. If x is not in
	 *         the list, the iterator points to null.
	 *
	 */
	...
	/**
	 * return iterator that points to a node before the first node that has x.
	 * If there is no x in the list, return iterator *that points to the last
	 * node in the list.
	 */
	 ...
	 * 
	 * @param x
	 *            is the item to be removed from the list.
	 */
	public void remove(Object x) {
		LinkedListItr p = findPrevious(x);

		if (p.current.next != null) // mean x is found because p is not the last
									// member.
